...
public class CreateDemo {
		...
		try {
			...
			Instructor tempInstructor = new Instructor("Melih" , "Ari" , "hidrojenxxx@gmail.com"); 
			InstructorDetail tempInstructorDetail = new InstructorDetail("meilhs.com" , "assMelih"); 
